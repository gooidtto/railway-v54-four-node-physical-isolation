...
export DATA_DIR="$D" XRAY_CONFIG="$C" UUID PRIVATE_KEY PUBLIC_KEY PUBLIC_DOMAIN RAILWAY_TCP_PROXY_DOMAIN="$TCP_HOST" RAILWAY_TCP_PROXY_PORT="$TCP_PORT" RAILWAY_TCP_APPLICATION_PORT="$TCP_APP" RAILWAY_TCP_PROXY_2_DOMAIN="$TCP2_HOST" RAILWAY_TCP_PROXY_2_PORT="$TCP2_PORT" RAILWAY_TCP_PROXY_2_APPLICATION_PORT="$TCP2_APP" RAILWAY_TCP_PROXY_3_DOMAIN="$TCP3_HOST" RAILWAY_TCP_PROXY_3_PORT="$TCP3_PORT" RAILWAY_TCP_PROXY_3_APPLICATION_PORT="$TCP3_APP" XRAY_HTTP_PORT=10086 XRAY_REALITY_PORT=10087 GATEWAY_PORTS="8080,8081,8082,8083" GATEWAY_READY_FILE="$READY_FILE" REALITY_SNI_CANDIDATES_FILE="${REALITY_SNI_CANDIDATES_FILE:-/opt/xray/config/reality-sni-candidates.txt}" WS_CERT WS_KEY WS_HOST
...
echo "RELEASE=$BUILD_ID";echo "ARCHITECTURE=physical-four-entry";echo "SUBSCRIPTION_INVARIANT=4";echo "443 -> 8080 -> 10086 XHTTP TLS";echo "8081 -> 10087 RAW REALITY Vision";echo "8082 -> 10088 gRPC REALITY";echo "8083 -> 10089 WS TLS";echo "NODES=4"
