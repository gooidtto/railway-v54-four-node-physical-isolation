...
set -eu
umask 077
BUILD_ID="test-4node-single-8080-grpc-reality"
...
REALITY_GRPC_SNI="${REALITY_GRPC_SNI:-www.microsoft.com}" REALITY_GRPC_TARGET="${REALITY_GRPC_TARGET:-www.microsoft.com:443}" \
GRPC_SERVICE_NAME="${GRPC_SERVICE_NAME:-grpc-service}" XHTTP_PATH="${XHTTP_PATH:-/xhttp}"
...
wait_port 127.0.0.1 10086 xhttp-http;wait_port 127.0.0.1 10087 raw-reality-vision-01;wait_port 127.0.0.1 10088 xhttp-reality;wait_port 127.0.0.1 10089 raw-reality-vision-02;wait_port 127.0.0.1 10090 grpc-reality
...
echo "RELEASE=$BUILD_ID";echo "ARCHITECTURE=single-8080-sni-router";echo "SUBSCRIPTION_INVARIANT=4";echo "TARGET_PORT=8080";echo "TCP=$TCP_HOST:$TCP_PORT -> 8080";echo "ROUTES=RAW1->10087,XHTTP-REALITY->10088,RAW2->10089,gRPC-REALITY->10090";echo "NODES=4"
