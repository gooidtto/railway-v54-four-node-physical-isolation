...
echo "RELEASE=$BUILD_ID";echo "ARCHITECTURE=single-8080-router";echo "SUBSCRIPTION_INVARIANT=3";echo "TARGET_PORT=8080";echo "TCP=$TCP_HOST:$TCP_PORT -> 8080";echo "ROUTES=HTTP->10086,RAW-REALITY->10087,XHTTP-REALITY->10088";echo "NODES=3"
