...
set -eu
umask 077
BUILD_ID="fixed-single-8080-router-v1"
...
TCP_HOST="${RAILWAY_TCP_PROXY_DOMAIN:-reseau.proxy.rlwy.net}";TCP_PORT="${RAILWAY_TCP_PROXY_PORT:-23337}"
TCP2_HOST="${RAILWAY_TCP_PROXY_2_DOMAIN:-interchange.proxy.rlwy.net}";TCP2_PORT="${RAILWAY_TCP_PROXY_2_PORT:-23389}"
TCP3_HOST="${RAILWAY_TCP_PROXY_3_DOMAIN:-altaria.proxy.rlwy.net}";TCP3_PORT="${RAILWAY_TCP_PROXY_3_PORT:-17903}"
...
# Remove obsolete physical-entry state; only secrets survive between releases.
...
RAILWAY_TCP_PROXY_2_DOMAIN="$TCP2_HOST" RAILWAY_TCP_PROXY_2_PORT="$TCP2_PORT" \
RAILWAY_TCP_PROXY_3_DOMAIN="$TCP3_HOST" RAILWAY_TCP_PROXY_3_PORT="$TCP3_PORT" \
...
echo "RELEASE=$BUILD_ID";echo "ARCHITECTURE=single-8080-protocol-router";echo "SUBSCRIPTION_INVARIANT=4";echo "TARGET_PORT=8080";echo "443 -> 8080 -> 10086 XHTTP TLS";echo "TCP_PROXY_1 -> 8080 -> SNI RAW -> 10087 REALITY Vision";echo "TCP_PROXY_2 -> 8080 -> SNI gRPC -> 10088 gRPC REALITY";echo "TCP_PROXY_3 -> 8080 -> SNI WS -> 10089 WS TLS";echo "NODES=4"
